...
addEmployees = () => {
  ...
  .then(answer => {
    ...
    connection.query(roles_var, (err, data) => {
      ...
      .then(rolesChoice => {
        const selectedRole = rolesChoice.role;
        parameters.push(selectedRole);
...
updateEmployeeRole = () => {
  ...
  connection.query(employeemysql, (err, data) => {
    ...
    .then(employeeChoice => {
      const selectedEmployee = employeeChoice.name;
      const parameters = [];
      parameters.push(selectedEmployee);
